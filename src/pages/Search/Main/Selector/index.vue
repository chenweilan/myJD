  ...
  <div class="clearfix selector">
    <div class="type-wrap logo">
      ...
      <div class="value logos">
        <ul class="logo-list">
          <li v-for="item in trademarkList" :key="item.tmId" @click="chooseTrademark(item)">{{item.tmName}}</li>
        </ul>
      </div>
      <div class="ext">
      ...
      <div class="fl value">
        <ul class="type-list">
          <li v-for="(value,index) in item.attrValueList" :key="index">
            <a @click="chooseAttrItem(item,value)">{{value}}</a>
          </li>
        </ul>
      </div>
...
export default {
    ...
    methods:{
      chooseTrademark(trademark){
        this.$emit("chooseTrademark",trademark)
      },
      chooseAttrItem(item,value){
        let newItem=Object.assign({},item)
        newItem.attrValue=value
        this.$emit("chooseAttr",newItem)
      }
    }
};
</script>
