    ...
    <section class="con">
      ...
      <div class="mainCon">
        ...
        <div class="previewWrap">
          <!--放大镜效果-->
          <Zoom :imageIndex="currentImageIndex" :imageList="imageList"/>
          <!-- 小图列表 -->
          <ImageList :imageList="imageList" @clickOneImage="clickOneImage"/>
        </div>
        <!-- 右侧选择区域布局 -->
        <div class="InfoWrap">
          ...
          <div class="choose">
            ...
            <div class="cartWrap">
              ...
              <div class="add" @click="addOrUpdateShopCart">
  ...
  export default {
    ...
    methods:{
      ...
      async addOrUpdateShopCart(){
        try{
          await this.$store.dispatch("addOrUpdateShopCart",{skuId:this.$route.params.goodsID,skuNum:this.skuNum})
